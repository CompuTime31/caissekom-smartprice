...
function findMatches(q){const n=norm(q);if(!n)return[];return articles.filter(a=>[a.code,a.designation,a.brand,a.category,a.manufacturerRef].some(v=>norm(v).includes(n))).slice(0,10);}
