const CACHE='smartprice-v1.4';
const ASSETS=['./','./index.html','./login.html','./manifest.json','./assets/style.css?v=1.4','./assets/app.js?v=1.4','./assets/auth.js?v=1.4','./assets/storage.js?v=1.4','./data/articles.json'];
