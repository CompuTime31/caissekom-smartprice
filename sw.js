const CACHE='smartprice-v1.6';
const ASSETS=['./','./index.html','./login.html','./manifest.json','./assets/style.css?v=1.5','./assets/app.js?v=1.5','./assets/auth.js?v=1.5','./assets/storage.js?v=1.5','./data/articles.json'];
