const CACHE='smartprice-v13-20260727';
const ASSETS=['./','./index.html','./login.html','./manifest.json','./assets/style.css?v=1.3','./assets/app.js?v=1.3','./assets/auth.js?v=1.3','./assets/storage.js?v=1.3','./data/articles.json'];
